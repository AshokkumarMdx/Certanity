...
# export PEER0_ORG2_CA=${PWD}/addOrg2/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org3.example.com/tls/ca.crt
...
export CHANNEL_NAME=org1-org2-channel
...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
        -c '{"function": "createCar","Args":["Car-1", "Audi", "R8", "Red", "krishna"]}'
